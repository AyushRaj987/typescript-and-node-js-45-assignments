...
// Adding guests
// dinnerGuests.unshift('David'); // Add guest at the beginning
// dinnerGuests.splice(Math.floor(dinnerGuests.length / 2), 0, 'Eve'); // Add guest in the middle
// dinnerGuests.push('Frank'); // Add guest at the end
// task 17
...
function carInfo(manufacturer, modelName) {
    ...
    for (var _a = 0, otherInfo_1 = otherInfo; _a < otherInfo_1.length; _a++) {
        var info = otherInfo_1[_a];
        for (var key in info) {
            car[key] = info[key];
        }
    }
